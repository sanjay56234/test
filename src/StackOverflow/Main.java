...
import StackOverflow.stackOverflow.StackOverflow;
...
public class Main {
    public static void main(String[] args) {
        ...
        // User login
        User loggedInUser = stackOverflow.login("john", "john@example.com");
        ...
        // Post an answer
        Answer answer1 = new Answer(1, "Java is an object-oriented programming language.", user2,
                new ArrayList<>(), 0,question1);
